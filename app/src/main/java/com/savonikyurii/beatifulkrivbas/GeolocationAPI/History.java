...
public class History {
    ...
    /*Сеттери та Геттери*/
    public DatabaseReference getmRefData() {
        return mRefData;
    }

    public void setmRefData(DatabaseReference mRefData) {
        this.mRefData = mRefData;
    }

    public ArrayList<Place> getHistoryList() {
        return historyList;
    }

    public void setHistoryList(ArrayList<Place> historyList) {
